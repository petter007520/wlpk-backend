...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	j.prototype.config = {
								...
								if (void 0 !== v && null !== v || (v = ""), !r.colGroup) {
									var m = ['<td data-field="' + c + '" data-key="' + h + '" ' + function() {
										...
										var n = t.extend(!0, {
											...
											s = d.config.disabledName;
										switch (r.type) {
											case "checkbox":
												return '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" ' + function() {
													var attr = r[o] ? (l[o] = r[o], r[o] ? "checked" : "") : n[o] ? "checked" : "";
													attr += l[s] ? "disabled" : "";
													return attr;
												}() + ">";
											case "radio":
			...
			i.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
				var e = t(this).prev(),
					a = i.layBody.find('input[name="layTableCheckbox"]:not(:disabled)'), // 选中的表格项
					l = e.parents("tr").eq(0).data("index"),
					n = e[0].checked,
					o = "layTableAllChoose" === e.attr("lay-filter");  // true:选中的是全选按钮, false:选中的是表格项
				o ? (a.each(function(e, t) {
					var index = $(this).closest("tr").data("index");
					t.checked = n, i.setCheckData(index, n)
